# app.py (The Definitive, Sharable, Fully-Featured, Single-Model Version)
...
# We only load the knowledge base at startup. The AI model is loaded later,
...
with st.sidebar:
    ...
    st.header("App Mode")
    # This radio button now correctly includes all three modes.
    app_mode = st.radio(
        "Choose a feature:",
...
if df_embedded is None:
    ...
    try:
        # This is the single point where the model is initialized. It only ever creates a Flash model.
